...
<body>
	<div class="container">
		...
		<br> Rodzice:<br>
					...
					<c:forEach var="item" items="${parents}">
						...
						<tr>
							...
							<td><form:form modelAttribute="invoice"
									action="${contextPath}/invoice" method="post">
									<form:label type="date" path="startDate"></form:label>
									<form:input type="hidden" name="id" path="id" value="${item.id}"></form:input>
									<form:input class="datepicker" id="startDate-${item.id}"
										path="startDate" /></td>
				...
				</table> <a href="child">Zapisz dziecko</a><br> <a href="activity">Dodaj
						zajęcia dodatkowe</a> <br> <a href="hello">powrót</a> </br>
	</div>
	</div>
