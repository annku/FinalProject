...
//		model.addAttribute(invoice);
	...
	/*
	 * action returns form to set dates to invoice
	 */
	@GetMapping("/newInvoice/{id}")
	public String newInvoice(@ModelAttribute Invoice invoice,@PathVariable long id) {
	...
	public String register(@ModelAttribute @Valid Invoice invoice, BindingResult result,@PathVariable long id) {
		...
		if(endDate.before(startDate)) {
			invoice.setEndDate(startDate);
			invoice.setStartDate(endDate);
		}
